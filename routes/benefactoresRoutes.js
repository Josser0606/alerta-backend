...
// 8. RESUMEN (Para la campanita de notificaciones)
router.get('/resumen', async (req, res) => {
    try {
        ...
        // 2. Pagos pendientes (Vencidos o Próximos 7 días)
        const sqlPagos = `
            SELECT COUNT(*) as count 
            FROM benefactores
        ...
        // Devolvemos estructura estándar: { hoy: X, proximos: Y }
        // Nota: Para benefactores, 'proximos' se refiere a pagos.
